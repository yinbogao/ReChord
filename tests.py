...
def positive_test_find_expressive_term():
    ...
    _, root = prepare_tree('database/mei_data/Chopin.xml')
...
def positive_test_search():
    ...
    tree, _ = prepare_tree('database/mei_data/Chopin.xml')
...
def positive_test_text_box_search_folder():
    ...
    assert len(text_box_search_folder("temp_database/MEI_Complete_examples", "Expressive Terms", "cresc.")) != 0, \
...
def positive_test_text_box_search():
    ...
    _, root = prepare_tree('temp_database/Chopin.xml')
...
def positive_test_snippet_search_folder():
    ...
    assert len(snippet_search_folder("temp_database/MEI_Complete_examples", input_xml)) != 0, \
